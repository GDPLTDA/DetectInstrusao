var atk ={ack : "dos",buffer_overflow : "u2r",ftp_write : "r2l",guess_passwd : "r2l",imap : "r2l",ipsweep : "probe",land : "dos",loadmodule : "u2r",multihop : "r2l",neptune : "dos",nmap : "probe",perl : "u2r",phf : "r2l",pod : "dos",portsweep : "probe",rootkit : "u2r",satan : "probe",smurf : "dos",spy : "r2l",teardrop : "dos",warezclient : "r2l",warezmaster : "r2l", normal:"normal"};
...
function totaliza(e){
    ...
    for (x in e){
      	if (x!=="_id"){
      		...
      		if (simb[x]!==undefined)
      			{
      				data[x] = (simb[x].indexOf(e[x]) * (1/simb[x].length))*coeficiente;
      			}
      		else if (val[x]!==undefined)
      			{
      				if (val[x].max!==0)
      					data[x] =  (e[x]/val[x].max)*coeficiente;	
      				else	
      					data[x]=null;
