...
Utilizando 4 redes, é testado diferentes entradas e saídas, de forma a encontrar uma ideal maneira de treinamento de uma rede neural, utilizando as 41 categorias disponíveis.
A primeira rede utiliza 9 entradas e uma saída, onde a saída pode ser -1 para normal e 1 para ataque.
A segunda rede utiliza todas as 41 entradas e uma saída, onde a saída pode ser -1 para normal e 1 para ataque.
A terceira utiliza 9 entradas e uma saída, onde a saída pode ser -1 para normal, 0 para Neptune e 1 Smurf.
